...
class SocialMediaUser(HttpUser):
    ...
    def search_hotel(self):
        ...
        r = self.client.get(url, name='search_hotel', timeout=(10, 10))
    ...
    def recommend(self):
        ...
        r = self.client.get(url, name='recommend', timeout=(10, 10))
        if r.status_code > 202:
    ...
    def reserve(self):
        ...
        r = self.client.post(url, name='reserve', timeout=(10, 10))
    ...
    def read_user_timeline(self):
        ...
        r = self.client.get(url, name='user_login', timeout=(10, 10))
